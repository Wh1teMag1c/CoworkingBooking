    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light navbar-glass sticky-top">
            <div className="container">
                <Link className="navbar-brand d-flex align-items-center fw-bold fs-4" to="/" onClick={handleScrollToTop}
                        ...
                        {user ? (
                            <div className="position-relative">
                                ...
                                >
                                    ...
                                    <svg className="text-muted flex-shrink-0" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                {dropdownOpen && (
                                    <div
                                        className="dropdown-menu show dropdown-menu-custom position-absolute end-0 mt-3 fade-in"
                                        style={{minWidth: '240px', zIndex: 1050}}>
                                        <div className="px-4 py-3 border-bottom mb-2 bg-light" style={{
                                        ...
                                        <Link
                                            ...
                                            to="/bookings" onClick={() => setDropdownOpen(false)}>
                                            <svg className="me-3" width="18" height="18" viewBox="0 0 24 24" fill="none"
                                                 stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                                 strokeLinejoin="round">
