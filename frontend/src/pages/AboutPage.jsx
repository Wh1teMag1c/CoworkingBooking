...
import aboutSpaceImg from '../assets/about-space.jpg';
            ...
            <div className="py-5 mb-5 bg-gradient-primary-soft position-relative overflow-hidden">
                <div className="container text-center py-5 position-relative z-1">
                    ...
                    <h1 className="fw-800 display-4 mb-4 text-dark">
                        Экосистема для вашего бизнеса <br/> с <span className="text-dark">Coworking</span><span
                        style={{color: 'var(--primary)'}}>Booking</span>
                    </h1>
                ...
                <div className="position-absolute top-0 start-0 translate-middle rounded-circle bg-white opacity-50"
                     style={{width: '400px', height: '400px', filter: 'blur(50px)'}}></div>
                <div
                    className="position-absolute bottom-0 end-0 translate-middle-y rounded-circle bg-primary opacity-10"
            ...
            <div className="container">
                <div className="row g-4 justify-content-center mb-5 mt-n5 position-relative z-2">
                    {[
                        ...
                        <div key={i} className="col-md-4 col-lg-3">
                            <div
                                className="p-4 rounded-4 bg-white text-center shadow-sm border-0 hover-lift h-100 d-flex flex-column justify-content-center">
                                <div
                                    className="d-inline-flex align-items-center justify-content-center rounded-circle badge-soft-primary mx-auto mb-3"
                ...
                <div className="py-5 mb-5">
                    <div className="text-center mb-5">
                        <span
                            className="text-uppercase text-primary fw-bold tracking-wider mb-2 d-block">Преимущества</span>
                    ...
                    <div className="row g-4">
                        <div className="col-md-4">
                            <div className="card h-100 border-0 shadow-sm p-4 hover-lift rounded-4">
                                <div
                                    className="d-inline-flex align-items-center justify-content-center rounded-circle badge-soft-success mb-4"
                                    style={{width: '60px', height: '60px'}}>
                                    <ShieldCheck size={30} className="text-success"/>
                                </div>
                                <h4 className="fw-bold mb-3">Гарантия брони</h4>
                                <p className="text-muted">Интеллектуальная система исключает накладки расписания. Если
                                    вы забронировали место или переговорную – они гарантированно ваши.</p>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="card h-100 border-0 shadow-sm p-4 hover-lift rounded-4">
                                <div
                                    className="d-inline-flex align-items-center justify-content-center rounded-circle badge-soft-primary mb-4"
                                    style={{width: '60px', height: '60px'}}>
                                    <Laptop size={30} className="text-primary"/>
                                </div>
                                <h4 className="fw-bold mb-3">Технологичность</h4>
                                <p className="text-muted">Всегда актуальная информация о наличии мониторов, эргономичных
                                    кресел, магнитных досок и необходимой периферии.</p>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="card h-100 border-0 shadow-sm p-4 hover-lift rounded-4">
                                <div
                                    className="d-inline-flex align-items-center justify-content-center rounded-circle badge-soft-warning mb-4"
                                    style={{width: '60px', height: '60px'}}>
                                    <Lightbulb size={30} className="text-warning"/>
                                </div>
                                <h4 className="fw-bold mb-3">Креативное комьюнити</h4>
                                <p className="text-muted">Наше space создано для нетворкинга. Находите партнеров,
                                    обменивайтесь идеями и растите в среде единомышленников.</p>
                            </div>
                        </div>
                    </div>
                </div>
