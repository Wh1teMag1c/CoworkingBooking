...
const LoginPage = () => {
    ...
    return (
        <div className="container d-flex align-items-center justify-content-center fade-in"
             style={{minHeight: '80vh', padding: '4rem 0'}}>
            <div className="row justify-content-center w-100">
                <div className="col-md-6 col-lg-4">
                    <div className="card border-0 rounded-4 shadow-lg p-4 p-md-5"
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="mb-3">
                                    <label className="form-label text-muted small fw-bold mb-2 ms-1"
                                           style={{letterSpacing: '0.5px'}}>ЛОГИН</label>
                                    <input
                                        type="text"
                                ...
                                <div className="mb-4">
                                    <label className="form-label text-muted small fw-bold mb-2 ms-1"
                                           style={{letterSpacing: '0.5px'}}>ПАРОЛЬ</label>
                                    <input
                                        type="password"
                                        className="form-control bg-light border-0 shadow-none px-3 py-3 rounded-3"
                                        value={password}
